            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleNotificationsSubmit} className="space-y-6">
                  {/* Canais */}
                  <div>
                    <h3 className="text-sm font-medium text-gray-900 mb-3">Notificações por email</h3>
                    <div className="space-y-3">
                      <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <div>
                          <p className="font-medium text-gray-700">Alertas de campanhas</p>
                          <p className="text-sm text-gray-500">Receba alertas sobre suas campanhas</p>
                        </div>
                        <input
                          type="checkbox"
                      ...
                      <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <div>
                          <p className="font-medium text-gray-700">Relatórios semanais</p>
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Quando o retorno sobre investimento cai</p>
                        </div>
                        <input
                          type="checkbox"
                      ...
                      <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Quando o orçamento diário é ultrapassado</p>
                        </div>
                        <input
                          type="checkbox"
